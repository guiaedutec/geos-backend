...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular "survey_section", "survey_sections"
  inflect.irregular "survey_question", "survey_questions"
  inflect.irregular "survey_response", "survey_responses"
  inflect.irregular "survey_answer", "survey_answers"
  inflect.irregular "city", "cities"
  inflect.irregular "user", "users"
  inflect.irregular "school", "schools"
  inflect.irregular "region", "regions"
  inflect.irregular "activity", "activities"
  inflect.irregular "manager", "manageres"
end
